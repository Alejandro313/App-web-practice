...
public class TestRepository {
    public static void main(String[] args) {
        ...
        ar.update(new Articulo("Pedi gree", "Carne", Tipo.ALIMENTO, EspecieRecomendada.CANINO, 500, 700, 10, 3, 20, "sin", true));
        System.out.println("****************************************");
        System.out.println("Consulta por nombre");
        ar.getLikeNombre("Pedi gree").forEach(System.out::println);
